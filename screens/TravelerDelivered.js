...
const TravelerDelivered = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch trips with status "dispatched" and start field equal to adminCity
  ...
  const handleReceived = async (tripId) => {
    try {
      ...
      // Update trip status to "reached inspector 2" when received
      await axios.put(
...
export default TravelerDelivered;
